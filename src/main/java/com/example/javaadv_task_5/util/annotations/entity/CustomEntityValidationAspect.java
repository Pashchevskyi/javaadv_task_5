package com.example.javaadv_task_5.util.annotations.entity;
...
public class CustomEntityValidationAspect {
    ...
    @Pointcut("@annotation(com.example.javaadv_task_5.util.annotations.entity.ActivateCustomAnnotations) && within(com.example.javaadv_task_5.service.*)")
